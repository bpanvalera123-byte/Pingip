...
class PingApp(ctk.CTk):
    ...
    def create_card(self, ip):
        ...
        # Поле для вывода пинга крупным шрифтом
        ...
        # Счётчик длительности потери связи
        ...
        self.cards[ip] = {
            ...
            "offline_since": None  # Время первого сбоя связи
        }
    ...
    def ping_host(self, host):
        ...
        try:
            # Скрываем окно консоли при вызове
            ...
            if "TTL=" in output or "ttl=" in output:
                # Извлекаем миллисекунды через регулярное выражение
            ...
            for ip in current_ips:
                ...
                if ip in self.cards:
                    ...
                    if success:
                        ...
                        # Фиксируем время, когда пинг пропал в первый раз
